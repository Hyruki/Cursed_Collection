...
dodge=[215, 250, pyxel.MOUSE_BUTTON_MIDDLE, 480, 0, dessin[1],1,3]#j'ai mit Button middle à la place de space ici
...
def afficher_pv_perso():#afficher la vie actuel du perso
    ...
    if pv>49:
        pyxel.blt(barre[0],barre[1],0,17,2,pv/100*60,12,1)#j'ai mit 17 au lieu de 1 ici
    if pv<50 and pv>19:
